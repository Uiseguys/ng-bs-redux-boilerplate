...
class CwcList {
    ...
    static get properties() { return { "addClass": { "type": String, "attr": "add-class" }, "addClassEven": { "type": String, "attr": "add-class-even" }, "addClassFirst": { "type": String, "attr": "add-class-first" }, "addClassLast": { "type": String, "attr": "add-class-last" }, "addClassOdd": { "type": String, "attr": "add-class-odd" }, "bindToList": { "type": Boolean, "attr": "bind-to-list" }, "bottomOffset": { "type": Number, "attr": "bottom-offset" }, "debounce": { "type": Number, "attr": "debounce" }, "el": { "elementRef": true }, "itemAs": { "type": String, "attr": "item-as" }, "items": { "type": "Any", "watchCallbacks": ["itemsdidChangeHandler"] }, "itemsData": { "state": true }, "loadMore": { "method": true }, "template": { "type": "Any" }, "wrapperClass": { "type": String, "attr": "wrapper-class" } }; }
    static get events() { return [{ "name": "onBottomReach", "method": "onBottomReach", "bubbles": true, "cancelable": true, "composed": true }]; }
    static get style() { return "cwc-list {\n  display: block;\n}"; }
}
