...
class ScbFileInput {
    ...
    static get properties() { return { "accept": { "type": String, "attr": "accept" }, "el": { "elementRef": true }, "element": { "state": true }, "files": { "type": "Any" }, "formDataName": { "type": String, "attr": "form-data-name" }, "headers": { "type": String, "attr": "headers" }, "maxFiles": { "type": Number, "attr": "max-files" }, "maxFileSize": { "type": Number, "attr": "max-file-size" }, "method": { "type": String, "attr": "method" }, "noAuto": { "type": Boolean, "attr": "no-auto" }, "nodrop": { "type": Boolean, "attr": "nodrop" }, "target": { "type": String, "attr": "target" }, "timeout": { "type": Number, "attr": "timeout" }, "type": { "type": "Any" } }; }
