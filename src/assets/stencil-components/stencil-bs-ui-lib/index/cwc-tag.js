...
class CwcTypeahead {
    ...
    static get properties() { return { "close": { "method": true }, "data": { "type": "Any" }, "filterValue": { "state": true }, "focusIndex": { "state": true }, "idValue": { "type": String, "attr": "id-value" }, "minSearchLength": { "type": Number, "attr": "min-search-length" }, "optionsShown": { "state": true }, "placeholder": { "type": String, "attr": "placeholder" }, "searchKey": { "type": String, "attr": "search-key" } }; }
