...
Route.properties = { "activeRouter": { "context": "activeRouter" }, "component": { "type": "Any", "attr": "component" }, "componentProps": { "type": "Any", "attr": "component-props" }, "exact": { "type": Boolean, "attr": "exact" }, "match": { "state": true }, "routeRender": { "type": "Any", "attr": "route-render" }, "url": { "type": "Any", "attr": "url" } };
...
var RouteLink = (function () {
    ...
    RouteLink.prototype.render = function () {
        var classes = (_a = {}, _a[this.activeClass] = this.match !== null, _a);
        if (this.custom) {
...
RouteLink.properties = { "activeClass": { "type": "Any", "attr": "active-class" }, "activeRouter": { "context": "activeRouter" }, "custom": { "type": Boolean, "attr": "custom" }, "exact": { "type": Boolean, "attr": "exact" }, "match": { "state": true }, "url": { "type": "Any", "attr": "url" } };
...
Router.properties = { "activeRouter": { "context": "activeRouter" }, "match": { "state": true }, "root": { "type": "Any", "attr": "root" } };
...
Redirect.is = "stencil-router-redirect";
Redirect.properties = { "activeRouter": { "context": "activeRouter" }, "url": { "type": "Any", "attr": "url" } };

export { Route as StencilRoute, RouteLink as StencilRouteLink, Router as StencilRouter, Redirect as StencilRouterRedirect };
