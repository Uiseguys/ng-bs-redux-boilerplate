...
class CwcMultiselect {
    ...
    render() {
        return (h("div", { id: this.idValue },
            h("div", { onInput: (e) => this.handleInputChange(e), class: "form-control", contentEditable: true },
                (() => {
                    return this.labels.map((label, i) => h("scb-badge", { contenteditable: "false" },
                        h("span", { contenteditable: false, class: "badge badge-secondary" },
                            " ",
                            this.getStringValue(label),
                            h("span", { "aria-hidden": "true", onClick: (e) => this.removeLabel(label) }, "\u00D7"))));
                })(),
                h("span", null, "\u00A0")),
            (() => {
                if (this.filtered.length > 0) {
    ...
    */
    ...
    static get properties() { return { "close": { "method": true }, "data": { "type": "Any" }, "filterValue": { "state": true }, "focusIndex": { "state": true }, "idValue": { "type": String, "attr": "id-value" }, "justAddedLabel": { "state": true }, "labels": { "state": true }, "minSearchLength": { "type": Number, "attr": "min-search-length" }, "optionsShown": { "state": true }, "placeholder": { "type": String, "attr": "placeholder" }, "results": { "state": true }, "searchKey": { "type": String, "attr": "search-key" } }; }
