                                ...
                                h("div", { class: "col-lg-4" },
                                    h("div", { class: "dropdown" },
                                        ...
                                        h("div", { class: "dropdown-menu", role: "menu" },
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExamplePlacement('bottom') }, "Bottom "),
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExamplePlacement('left') }, "Left "),
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExamplePlacement('right') }, "Right "),
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExamplePlacement('top') }, "Top "))),
                                    h("div", { class: "dropdown" },
                                        ...
                                        h("div", { class: "dropdown-menu", role: "menu" },
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExampleAlignment('') }, "None (centered)"),
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExampleAlignment('start') }, "Start "),
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExampleAlignment('end') }, "End "))),
                                    h("div", { class: "dropdown" },
                                        ...
                                        h("div", { class: "dropdown-menu", role: "menu" },
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExampleTriggerOverflow(true) }, "True"),
                                            h("a", { class: "dropdown-item", role: "presentation", onClick: (event) => this.setExampleTriggerOverflow(false) }, "False")))),
                                h("div", { class: "col-12" },
                                    h("pre", null,
...
export { StencilComponent as DropdownPage };
